        ...
        <div className="text-center">
          <div className="mb-4">
            <div className="inline-flex items-center justify-center w-12 h-12 bg-[var(--color-accent-primary)]/10 rounded-full mb-3">
              <svg className="w-6 h-6 text-[var(--color-accent-primary)] animate-spin" fill="none" viewBox="0 0 24 24" aria-hidden="true">
          ...
          {imagePullProgress.error ? (
            ...
            <div className="space-y-3">
              ...
              <div className="w-full bg-[var(--color-bg-tertiary)] rounded-full h-1.5 overflow-hidden">
                {progressScale != null ? (
                  <div className="bg-[var(--color-accent-primary)] h-full rounded-full transition-transform duration-200 origin-left" style={{ transform: `scaleX(${progressScale})` }}></div>
                ) : (
