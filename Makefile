...
# 构建标志
LDFLAGS = -X main.Version=$(VERSION) -X main.BuildTime=$(BUILD_TIME) -X main.GitCommit=$(GIT_COMMIT) -X kwdb-playground/internal/config.Version=$(VERSION) -X kwdb-playground/internal/config.BuildDefaultUseEmbed=true
