...
支持暂停和恢复学习进度，方便分时段完成课程：

- **容器暂停**：在课程学习页面可以暂停正在运行的容器，保留当前状态
- **自动暂停**：关闭课程页面时自动暂停容器，避免容器被销毁
- **进度恢复**：重新打开课程时可以恢复之前暂停的容器，继续学习
- **状态指示**：清晰显示容器当前状态（运行中、已暂停、已停止等）
- **灵活控制**：支持在暂停、运行、停止状态之间自由切换

这一功能特别适合耗时较长的实战课程，学习者可以随时暂停，稍后继续，学习进度和环境状态都会被保留。
