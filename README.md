...
无论您使用哪种安装方式，KWDB Playground 的核心环境隔离功能都依赖于 Docker。请确保在启动前您的机器上已安装并运行 Docker：
...
我们非常欢迎并感谢任何形式的贡献，无论是提交代码、完善文档还是反馈 Bug！

- 🐛 **提交 Bug 或建议**：如果您发现了问题或有新功能建议，请随时提交 [Issue](https://github.com/KWDB/playground/issues)。
- 💻 **贡献代码**：如果您想直接贡献代码，请 Fork 本仓库并提交 Pull Request。贡献之前请先阅读 [贡献指南](./CONTRIBUTING.md)。
- 💬 **社区交流**：欢迎加入我们的社区参与讨论与交流。
